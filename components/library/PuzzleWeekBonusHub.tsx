...
const PUZZLE_WEEK_STARBATTLE_SOLVED_VERSION = 11
...
// 9×9, 9 regions, 2 stars per row/col/region — 5 verified unique-solution puzzles
const SB_MEDIUM_BASE: StarBattlePuzzle[] = [
  ...
  },
  {
    ...
    solution: [6, 8, 11, 13, 18, 25, 29, 31, 36, 42, 48, 53, 55, 59, 66, 70, 73, 77],
  },
  {
    size: 9,
    regions: [
    ...
    solution: [3, 7, 10, 14, 21, 25, 27, 32, 38, 44, 49, 51, 55, 62, 67, 69, 72, 74],
  },
  {
    size: 9,
    regions: [
    ...
    solution: [5, 7, 10, 12, 23, 25, 27, 29, 40, 42, 47, 53, 54, 58, 69, 71, 73, 75],
  },
  {
    size: 9,
    regions: [
    ...
    solution: [2, 5, 9, 16, 21, 23, 27, 34, 38, 40, 51, 53, 55, 58, 69, 71, 73, 75],
  },
]

const SB_MEDIUM_ORDER = [0, 1, 2, 3, 4] as const
