...
const paletteInitScript = `
  try {
    var palettes = {
      abra:     {'--color-bg':'#EAE0CD','--color-surface':'#FFFFFF','--color-panel':'#F6F0E3','--color-text':'#0E3D38','--color-muted':'#5A726E','--color-accent':'#16A89B','--color-accent-light':'#E2F4F1','--color-accent-chip':'#CFE9E3','--color-border':'#D6C9B0','--color-grid-header':'#0E3D38','--color-grid-selected':'#E2F4F1','--color-accent-strong':'#0D6E64','--color-gold':'#E8920C','--color-gold-light':'#FBEAC9'},
      ...
      classroom:{'--color-bg':'#FFFFFF','--color-surface':'#FFFFFF','--color-text':'#082621','--color-muted':'#3A4D49','--color-accent':'#0C8074','--color-accent-light':'#C6ECE7','--color-border':'#94A8A3','--color-grid-header':'#082621','--color-grid-selected':'#FFE08A','--color-accent-strong':'#0A6A60','--color-gold':'#D97706','--color-gold-light':'#FFE08A'},
    };
