  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        disabled={loading}
        className="flex items-center gap-3 px-6 py-3 bg-[var(--color-accent)] text-white rounded-lg font-medium hover:bg-teal-600 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
      >
        {loading ? (
