    ...
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="text-[var(--color-muted)] leading-relaxed">
          RedPen grades bubble-sheet assessments. Print sheets for your section, hand them out with your
          assessment, scan the completed stack on your school&apos;s copier or any scanner with a document
          feeder, upload the scanned assessments, and get graded papers and summaries back.
        </p>
      </div>
