...
const paletteInitScript = `
  try {
    var palettes = {
      abra:     {'--color-bg':'#F7F2E8','--color-surface':'#FFFFFF','--color-text':'#0E3D38','--color-muted':'#5A726E','--color-accent':'#16A89B','--color-accent-light':'#E2F4F1','--color-border':'#DCE6E3','--color-grid-header':'#0E3D38','--color-grid-selected':'#E2F4F1','--color-accent-strong':'#0D6E64','--color-gold':'#E8920C','--color-gold-light':'#FBEFD6'},
